...
import { User, USER_ROLES } from '@/types/user.type';
...
export function UpdateUserCard() {
  ...
  return (
    <Card className="max-h-[80vh] sm:max-h-[90vh] overflow-y-auto w-full max-w-md sm:max-w-lg mx-auto">
      <CardHeader>
      ...
      <Tabs defaultValue="account">
        ...
        <TabsContent value="account">
          <Card className="h-fit flex flex-col mt-4">
            <CardHeader>
        ...
        <TabsContent value="password">
          <Card className="mt-4">
            <CardHeader>
              ...
              <CardDescription>
                Elegir nueva contraseña. Luego de actualizar se cerrará la sesión.
              </CardDescription>
            </CardHeader>
            <Form {...passwordForm}>
